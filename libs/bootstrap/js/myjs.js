...
// Bind to the submit event of our form
    $("#loginform").submit(function (event) {
        ...
        request.done(function (response, textStatus, jqXHR) {
            ...
            //if response is == success then navigate to page
            if(response == "sucess"){
                window.location.href="/stockbalance";
            }
...
//prepare stock images and information
var request;
function getalldata() {
    if (request) {
        request.abort();
...
//end of preparing  stock images and information
